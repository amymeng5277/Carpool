 ...
 * PUT     /api/passengers/:id          ->  upsert
 * PATCH   /api/passengers/:id          ->  patch
...
// Upserts the given Passenger in the DB at the specified ID
export function upsert(req, res) {
  if(req.body._id) {
    delete req.body._id;
  }

  return Passenger.upsert(req.body, {
    where: {
      _id: req.params.id
    }
  })
